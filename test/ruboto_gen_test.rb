...
class RubotoGenTest < Test::Unit::TestCase
  ...
  # APK was larger than 7400.0KB: 9929.8KB.  PLATFORM: STANDALONE, ANDROID_TARGET: 10, JRuby: 1.7.3.dev.
  # APK was larger than 9970.0KB: 10313.8KB.  PLATFORM: STANDALONE, ANDROID_TARGET: 15, JRuby: 1.7.3.dev
  def test_new_apk_size_is_within_limits
    ...
    if RUBOTO_PLATFORM == 'STANDALONE'
      upper_limit = {
          ...
          '1.7.2' => 9970.0,
      }[JRUBY_JARS_VERSION.to_s] || 10400.0

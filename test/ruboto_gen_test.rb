...
class RubotoGenTest < Test::Unit::TestCase
  ...
  # APK was    55.2KB.  PLATFORM: CURRENT,    ANDROID_TARGET: 10
  # APK was    54.5KB.  PLATFORM: CURRENT,    ANDROID_TARGET: 15
  ...
  # APK was  8407.1KB.  PLATFORM: STANDALONE, ANDROID_TARGET: 10, JRuby: 1.7.4.dev
  ...
  def test_new_apk_size_is_within_limits
    ...
    if RUBOTO_PLATFORM == 'STANDALONE'
      upper_limit = {
          ...
          '1.7.2' => 7400.0,
          '1.7.3' => 7400.0,
      }[JRUBY_JARS_VERSION.to_s] || 8407.1

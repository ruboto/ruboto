  ...
  def on_create(bundle)
    ...
    self.content_view =
        linear_layout :orientation => LinearLayout::VERTICAL, :gravity => android.view.Gravity::CENTER do
          ...
          @script_view              = text_view :id => 42, :text => STACK_DEPTH_SCRIPT, :text_size => 48.0
          @class_view               = text_view :id => 43, :text => STACK_DEPTH_CLASS, :text_size => 48.0
          @handle_create_view       = text_view :id => 44, :text => stack_depth_on_create, :text_size => 48.0
          @linear_layout_view       = text_view :id => 45, :text => stack_depth_linear_layout, :text_size => 48.0
        end
  end
end
